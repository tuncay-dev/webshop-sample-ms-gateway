...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("webshopSampleMsGateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("webshopSampleMsGateway");
        ...
        config.getMapConfigs().put("dk.tuncay.webshop.domain.*", initializeDomainMapConfig(jHipsterProperties));
